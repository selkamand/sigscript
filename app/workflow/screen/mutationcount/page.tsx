        ...
        <div>
            <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
                ...
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-1xl sm:p-20">
                    ...
                    <p className="text-center pb-8">Interpreting mutational signatures for samples with low mutation counts is unreliable. Ensure your sample has a sufficient number of mutations before proceeding.</p>
                    <hr className="" />
                    <div className="grid sm:grid-cols-3 gap-4">
                        <div className="p-8 flex flex-col items-center text-center">
                            <h1 className="font-bold text-blue-500 text-lg">Sufficient Mutations</h1>
                            <p className="text-sm font-light text-gray-400 pt-4 pb-4">This patient has a large number of mutations. </p>
                        ...
                        <div className="p-8 flex flex-col items-center text-center">
                            ...
                            <Link href="/workflow/screen/mutationcountfail"><button className="bg-blue-500 text-white font-bold py-2 px-4 hover:scale-110 duration-75">{'->'}</button></Link>
                        </div>
                        <div className="p-8 flex flex-col items-center text-center">
