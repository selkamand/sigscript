        ...
        <div>
            <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
                ...
                <div className="relative px-4 py-10 bg-orange-100 shadow-lg sm:rounded-1xl sm:p-20">
                    ...
                    <p className="text-center pb-8">Consider exploring other types of signatures. For example, if you have a low number of single base substitutions (SBS), SBS signature analysis may not be beneficial, but you might have enough insertions and deletions (INDELs) for indel signature analysis or enough large rearrangements for structural variant signature analysis.</p>
