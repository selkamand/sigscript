    ...
    <div className="bg-white">
        ...
        <div
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Learn best-practices for how to perform and interpret a mutational signature analysis
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
              ...
              <Link href="/reference" className="text-sm font-semibold leading-6 text-white">
      ...
      <div className="bg-orange-300 text-center py-4 lg:px-4">
        <div className="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
          ...
          <span className="font-semibold mr-2 text-left flex-auto">SigScript interpretation guidelines are easier to apply after running your cancer data through <TextLink text="SigScreen" newtab={true} href="https://github.com/selkamand/sigscreen" hovercolour="text-white"></TextLink></span>
